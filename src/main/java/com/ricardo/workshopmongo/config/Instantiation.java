...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
		...
		userRepository.saveAll(Arrays.asList(maria, alex, bob)); // Para pegar o ID o usuário deve ser salvo antes para que o Post possa ser associado a ele

		Post post1 = new Post(null, sdf.parse("21/03/2018"), "Partiu viagem", "Vmariaviajar para São Paulo. Abraços!", new AuthorDTO(maria));
